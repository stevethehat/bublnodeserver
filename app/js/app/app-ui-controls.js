...
ControlGroupControl.prototype = new ZEN.ui.View();
_.extend(
	...
	PaletteItemControl.prototype,
		{
			...
			render: function (params) {
				...
				if(params.icon != undefined){
					var div = $('<div class="paletteItem fa ' + params.icon + ' fa-1x"/>').appendTo(this.el);
	...
	IconControl.prototype,
		{
			...
			render: function (params) {
				var div = $('<div class="icon fa ' + params.icon + ' fa-1x"/>').appendTo(this.el);
			}
		}
);
